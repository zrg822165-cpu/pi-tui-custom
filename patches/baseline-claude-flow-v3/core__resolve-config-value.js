 ...
 */
import { runProcessSync, runShellCommandSync } from "../../../../../shell-executor/index.mjs";
...
function executeWithConfiguredShell(command) {
    try {
        ...
        const result = runProcessSync(shell, [...args, command], {
            encoding: "utf-8",
            timeout: 10000,
...
function executeWithDefaultShell(command) {
    try {
        const output = runShellCommandSync(command, {
            encoding: "utf-8",
            timeout: 10000,
            stdio: ["ignore", "pipe", "ignore"],
        });
