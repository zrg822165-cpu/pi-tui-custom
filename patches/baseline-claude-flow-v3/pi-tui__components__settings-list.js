...
function getPrintableSearchText(data) {
...
export class SettingsList {
    ...
    handleInput(data) {
        ...
        if (kb.matches(data, "tui.select.up")) {
            ...
            const searchEditKey = kb.matches(data, "tui.editor.deleteCharBackward") ||
            ...
            const printable = getPrintableSearchText(data);
            const inputData = printable?.replace(/ /g, "") ?? (searchEditKey ? data : "");
            if (!inputData) {
                return;
            }
            this.searchInput.handleInput(inputData);
            this.applyFilter(this.searchInput.getValue());
            this.invalidate();
        }
    }
    cycleSelectedValue(direction) {
        ...
        else if (direction > 0 && item.submenu) {
            this.activateItem();
        }
    }
    activateItem() {
