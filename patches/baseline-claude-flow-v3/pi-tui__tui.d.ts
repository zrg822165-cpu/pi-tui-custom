...
export declare class Container implements Component {
    ...
    private cachedWidth?;
    private cachedLines?;
    private visibleTailLines?;
    private dirty;
    __piDirtyVersion: number;
    protected cacheable: boolean;
    __piRenderCacheSafe: boolean;
    private appendOnlyCacheEnabled;
    private appendChildCache;
    private appendLastStats?;
    private appendLastFirstDirtyChildIndex?;
    private appendLastCachedTranscriptLines;
    setAppendOnlyCacheEnabled(enabled: boolean): void;
    private resetAppendOnlyCache;
    setVisibleTailLines(maxLines?: number): void;
    private applyVisibleTail;
    private renderVisibleTail;
    private isCacheSafeChild;
    private attachChild;
    private detachChild;
    private getChildDirtyVersion;
    private isChildDirty;
    markDirty(): void;
    addChild(component: Component): void;
    removeChild(component: Component): void;
    clear(): void;
    invalidate(): void;
    private renderAppendOnly;
    getAppendOnlyStats(): {
        hits: number;
        misses: number;
        firstDirtyChildIndex?: number;
        cachedTranscriptLines: number;
    } | undefined;
    render(width: number): string[];
}
/**
...
export declare class TUI extends Container {
    ...
    private patchEngine;
    private patchWriter;
    private frameStateAdapter;
    private framePlanner;
    ...
    stop(): void;
    requestRender(force?: boolean, reason?: string): void;
    private scheduleRender;
    patchMarkedLine(marker: string, nextLine: string): boolean;
    private handleInput;
