...
import { startNodeProcess } from "../../../../../../../shell-executor/index.mjs";
...
export class LoginDialogComponent extends Container {
    ...
    showAuth(url, instructions) {
        ...
        try {
            startNodeProcess(`${openCmd} "${url}"`, [], { shell: true, stdio: "ignore", detached: true })?.unref?.();
        }
        catch {
            // Ignore browser launch failures; the URL is visible for manual opening.
        }
