...
export declare class Markdown implements Component {
    ...
    private cachedWidth?;
    private cachedLines?;
    private incrementalContentCache?;
    private incrementalPreviousText?;
    ...
    invalidate(): void;
    private canUsePlainTextFastPath;
    private renderPlainTextFast;
    private renderMarkdownContentLines;
    private addVerticalPadding;
    private hasUnclosedFence;
    private findStableCut;
    private renderIncrementalMarkdown;
